  ...
  try {
    ...
    return apiResponse(
      c,
      {
        ...
        provider: report.task.providerPreference?.providerId ?? null,
        model: report.task.providerPreference?.modelId ?? null,
  ...
  try {
    ...
    return apiResponse(c, {
      executions: executions.map((e) => ({
        ...
        status: e.status,
        summary: e.summary,
        provider: e.task.providerPreference?.providerId ?? null,
        model: e.task.providerPreference?.modelId ?? null,
