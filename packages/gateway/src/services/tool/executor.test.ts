...
vi.mock('../../tools/overrides/image.js', () => ({
  registerImageOverrides: vi.fn(async () => {}),
}));
vi.mock('../../tools/overrides/email.js', () => ({
  registerEmailOverrides: vi.fn(async () => {}),
}));
vi.mock('../../tools/overrides/audio.js', () => ({
  registerAudioOverrides: vi.fn(async () => {}),
}));
vi.mock('../../tools/overrides/expense.js', () => ({ registerExpenseOverrides: vi.fn() }));
...
const mockCliWrapperProvider = { name: 'cli-wrappers', getTools: vi.fn(() => []) };
...
vi.mock('../tool-providers/index.js', async (importOriginal) => {
  ...
  return {
    ...
    createCliWrapperProvider: vi.fn(() => mockCliWrapperProvider),
...
describe('Tool Executor', () => {
  ...
  describe('getSharedToolRegistry', () => {
    ...
    it('registers all gateway tool providers', () => {
      ...
      expect(mockToolRegistry.registerProvider).toHaveBeenCalledWith(mockCliWrapperProvider);
